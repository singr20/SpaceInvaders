            ...
            for(int r = 0; r < al.length; r++){
                for(int c = 0; c < al[0].length; c++){
                    for(int i=0; i<shotsx.size(); i++){
                        if(al[r][c].y >= shotsy.get(i) - 10 && al[r][c].y <= shotsy.get(i) + 10 && al[r][c].x >= shotsx.get(i) - 10 && al[r][c].x <= shotsx.get(i) + 10 ){
                           shotsx.remove(i);
                           shotsy.remove(i);
                           al[r][c].y = 5000;
                           count ++;
            ...
            for(int r = 0; r < al.length; r++){
                for(int c = 0; c < al[0].length; c++){
                    for(int i=0; i<bombx.size(); i++){
                        if(al[r][c].y >= bomby.get(i) - 10 && al[r][c].y <= bomby.get(i) + 10 && al[r][c].x >= bombx.get(i) - 10 && al[r][c].x <= bombx.get(i) + 10){
                           bombx.remove(i);
                           bomby.remove(i);
                           if(al[r][c].y != 5000){
                               al[r][c].y = 5000;
